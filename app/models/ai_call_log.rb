class AiCallLog < ApplicationRecord
  ...
  # nyk_grocery_list + nyk_recipe_extract are Opus, not Haiku;
  # cost_dollars/total_cost_dollars price them correctly via RATES, but keep
  # them out of any Haiku-flat usage_rollup.
  NYK_SOURCES = %w[nyk_enhance nyk_x_autopost nyk_team_report nyk_recipe_extract nyk_receipt_extract nyk_grocery_list].freeze
