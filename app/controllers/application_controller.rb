class ApplicationController < ActionController::Base
  ...
  WORKSPACE_ALLOWED_PREFIXES = %w[/workspaces /invitations /notifications /feedback /session /sign_in /email_verification /passwords /settings /impersonate /api /assets /rails/active_storage].freeze
