...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_120000) do
  ...
  create_table "feedbacks", force: :cascade do |t|
    ...
    t.integer "pr_additions"
    t.string "pr_checks"
    t.integer "pr_deletions"
    t.integer "pr_files_changed"
  ...
  create_table "kitchen_packets", force: :cascade do |t|
    ...
    t.text "source_text"
    t.string "source_url"
    t.string "station_label", default: "Single", null: false
  ...
  create_table "workspace_memberships", force: :cascade do |t|
    ...
    t.boolean "echo_email_enabled", default: true, null: false
    t.datetime "last_active_at"
